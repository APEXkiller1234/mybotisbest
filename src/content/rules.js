...
/**
 * Exact message content sent by the `!rules` command.
 * Keep this file as the single source of truth for the rules text.
 */
module.exports = `| 🔹 AVOID ARGUMENTS, AND TOXICITY
