 ...
 *   mmtos:view (button)       → shows the full Middleman Terms of Service
 */
module.exports = {
...
/**
 * "View ToS" — posts the full Middleman Terms into the channel.
 * Automatically splits across embeds if the text exceeds Discord limits.
 */
